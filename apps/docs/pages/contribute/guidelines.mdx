...
We have the community group to discuss all things about grimoire development.
...
{/* TODO: ADD feature branch EXAMPLE */}
...
2. After cloning the repository, run `pnpm i` in the site folder of the repository. This will install all dependencies as well as build all local packages.
