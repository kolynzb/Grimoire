...
2. After cloning the repository, run `pnpm ` in the site folder of the repository. This will install all dependencies as well as build all local packages.
3. To start a development server, run `pnpm dev`.
